...
def user_int2():
    ...
    print ('Do you want to exit (Resets the Program)? ---5')
    ch_1 = (input('Please enter the appropriate number '))  #input user to choose a particular methos
    return ch_1

tc1 = () 
list = []     #assigning empty paramters for manipulation inside the while loop
ph_no =[]
tc=0
while True:    #assigning loop for the menu-driven program
    ...
    if a =='1': 
        ...
        print(Fore.YELLOW+'THANK YOU FOR USING THE PROGRAM !!!')
        print (Style.RESET_ALL)     #reset colour patterns 
        break #end the program 
